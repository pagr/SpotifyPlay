...
public final class Bars: NSCoding {
  ...
  public required init(json: JSON) {
    ...
    confidence = json[SerializationKeys.confidence].int
  }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.confidence = aDecoder.decodeObject(forKey: SerializationKeys.confidence) as? Int
  }
